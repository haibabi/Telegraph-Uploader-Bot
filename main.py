...
Bot = Client(
    ...
    bot_token=os.environ.get("5583506387:AAFVBDIhQRX9PbfoGr_QEeL46NV7mvRJQLw"),
    api_id=int(os.environ.get("18662296")),
    api_hash=os.environ.get("b7228abe25488b4b65151d387379f5ea")
)
